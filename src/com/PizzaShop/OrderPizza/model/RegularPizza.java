...
public class RegularPizza extends Pizza {
    ...
    public final static String REGULAR_PIZZA = "regular";
    private static int vegPizzaPrice = 200;

    private static int nonVegPizzaPrice = 300;
    ...
    public RegularPizza(String pizzaSizeCommand, String pizzaTypeCommand, List<String> extrasList, int pizzaQuantity, String pizzaDeliveryType) {
